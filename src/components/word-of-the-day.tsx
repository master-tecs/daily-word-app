      ...
      <Card className={`w-full max-w-md shadow-lg ${darkMode ? 'bg-gray-800' : 'bg-[#faf7e8]'}`}>
        <CardHeader className="relative">
          ...
          {isLoading ? (
            ...
            <h2 className={`text-4xl font-bold mb-4 ${darkMode ? 'text-white' : 'text-black'}`}>«Personalia»</h2>
          )}
          ...
          {isLoading ? (
            ...
            <>
              <div className="flex items-center justify-between">
                <h3 className={`text-2xl font-bold ${darkMode ? 'text-white' : 'text-black'}`}>«Personalia»</h3>
                <Button variant="ghost" size="icon" className={darkMode ? 'text-green-400' : 'text-[#2c6e49]'}>
              ...
              <p className={darkMode ? 'text-gray-300' : 'text-gray-500'}>[pur-suh-ney-lee-uh,-neyl-yuh]</p>
              <div>
